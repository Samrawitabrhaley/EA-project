...
INSERT INTO ea_badge.Plan (id, Description, PlanName, Rule_id, active) VALUES (1, '90 times a month', '90x a month', 1, true);
INSERT INTO ea_badge.Plan (id, Description, PlanName, Rule_id, active) VALUES (2, '3 times a day for student, staff and faculty', '3x a day', 2, true);
INSERT INTO ea_badge.Plan (id, Description, PlanName, Rule_id, active) VALUES (3, '1 time a day for staff and faculty', '1x a day', 3, true);
